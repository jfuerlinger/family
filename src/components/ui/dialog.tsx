...
/**
 * Modal dialog: centered on desktop, bottom sheet on mobile.
 */
  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        className={cn(
          'animate-pop-in flex max-h-[92dvh] w-full flex-col rounded-t-2xl border border-white/60 bg-white shadow-2xl shadow-slate-900/10',
